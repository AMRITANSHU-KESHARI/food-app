...
Do check out this project and in case if you're getting started and need assistance or find any bugs within my project, feel free to contact me.
...
If you want to set up the project locally on your machine then follow these steps.
